...
import static com.anitha.offsitefinal.R.id.action_bar_subtitle;
import static com.anitha.offsitefinal.R.id.close;
...
*/
                chl.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        int clickedItem = chl.indexOfChild((View) parent.getAdapter().getItem(position));


                        //  String s = chl.getItemAtPosition(i).toString();
                        Toast.makeText(getApplicationContext(), "Place Your Code" + NameList[clickedItem] + " selected", Toast.LENGTH_SHORT).show();
...
/*
      ...
      /*  View header = navigationView.getHeaderView(11);
        navigationView = header.findViewById(R.id.version);


        navigationView.setTag(versionName);
...
*/
        ...
        for (int i = 0; i < m.size(); i++) {
          ...
          //  if (i == 10) {
                ...
                mi.setTitle("AppVer:" + versionName);
